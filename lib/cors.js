...
exports.route = function (options) {
    ...
    for (var i = 0; i < settings._headers.length; ++i) {
    ...
    if (settings.origin.indexOf('*') !== -1) {
        ...
        for (var y = 0; i < settings.origin.length; ++y) {
            const origin = settings.origin[y];
            if (origin.indexOf('*') !== -1) {
...
exports.matchOrigin = function (origin, settings) {
    ...
    for (var i = 0; i < settings._origin.wildcards.length; ++i) {
